<x-layout>
    ...
    <form method="POST" action="/login" class="max-w-xl mx-auto space-y-6">
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <input type="email" name="email" id="email" required class="rounded-xl bg-white/5 border-white/10 px-5 py-4 border border-gray-200 dark:border-white/10 text-black dark:text-white placeholder-gray-500 focus:border-blue-600 focus:ring-blue-600 w-full">
        </div>
